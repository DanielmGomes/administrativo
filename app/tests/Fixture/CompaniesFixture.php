...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'company' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'trade' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'companiescol' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'activity' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'companiescol' => 'Lorem ipsum dolor sit amet',
                'activity' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-04-16 22:39:19',
                'modified' => '2019-04-16 22:39:19',
                'users_id' => 1
            ],
        ];
        parent::init();
